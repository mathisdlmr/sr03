...
export const inviteUser = (idUser, idChat) =>
  apiPost('invitations', new URLSearchParams({ idUser, idChat }));
...
export const searchUninvitedUsers = (idChat, q) =>
  apiGet(`users/${idChat}/search?q=${encodeURIComponent(q)}`);

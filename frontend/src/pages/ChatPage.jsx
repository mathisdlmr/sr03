...
export default function ChatPage() {
  ...
  const handleFileSelect = (e) => {
    ...
    if (file.size > 5 * 1024 * 1024) { // 5 Mo max, même limite que pour les images
        ...
        {loading ? (
            ...
            <div className="d-flex" style={{ height: '100vh', fontFamily: "'DM Sans', sans-serif" }}>
              <div className="d-flex flex-column" style={{ flex: 1 }}>
                <div className="d-flex flex-align-center flex-justify-between p-3 bg-light" style={{ borderBottom: '1px solid #ddd', flexWrap: 'wrap', gap: 8 }}>
                  <div style={{ minWidth: 0 }}>
                    <h3 className="m-0" style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  ...
                  <div className="d-flex flex-align-center gap-2">
                    {connected ? (
                        <span className="badge inline bg-green fg-white p-2" style={{fontSize: "0.8rem"}}>
                        ...
                        >
                          {!isMe && (
                              <div className="mr-2 d-flex flex-column justify-content-end">
                                {msg.avatar ? (
                                    <img src={msg.avatar} alt="" style={{ width: 36, height: 36, borderRadius: '50%', objectFit: 'cover' }} className='mt-auto' />
                                ) : (
                                    <div className="d-flex flex-align-center flex-justify-center bg-blue fg-white text-bold mt-auto" style={{
                ...
                <div className="d-flex flex-align-center gap-2 p-3 bg-light" style={{ borderTop: '1px solid #ddd' }}>
                  ...
                  {isRecording ? (
                      <>
                        ...
                        <div className="d-flex flex-align-center flex-justify-center gap-2" style={{ flex: 1, height: 36 }}>
                        ...
                        <button
                            ...
                            style={{height: "35px"}}
                        >
                          <span className="mif-paper-plane mr-1" /> <span className="chat-send-label">Envoyer</span>
                        </button>
                      </>
                  ) : (
                      <>
              ...
              />
              <div className={`chat-sidebar d-flex flex-column bg-light ${sidebarOpen ? 'open' : ''}`} style={{ width: 240, borderLeft: '1px solid #ddd' }}>
                <div className="p-3 d-flex flex-align-center flex-justify-between" style={{ borderBottom: '1px solid #ddd' }}>
                  <h4 className="m-0">
                          ...
                          <div style={{ minWidth: 0, overflow: 'hidden' }}>
                            ...
                            <div>
                              {u.id === chat.creator_id && (
                                  <span className="badge inline bg-violet fg-white mr-1" style={{ fontSize: 12 }}>Creator</span>
                              )}
                              {u.admin && (
                                  <span className="badge inline bg-blue fg-white" style={{ fontSize: 12 }}>Admin</span>
                              )}
                            </div>
                          </div>
                        </div>
